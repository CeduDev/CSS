...
from cdktf_cdktf_provider_google.compute_firewall import (
    ComputeFirewall,
...
network = ComputeNetwork(stack, "cdktf-network", name="cdktf-network")
...
ssh_firewall_rule = ComputeFirewall(
    ...
    target_tags=["ssh"],
    allow=[ComputeFirewallAllow(protocol="tcp", ports=["22"])],
)
...
instance = ComputeInstance(
    ...
    network_interface=[
        ComputeInstanceNetworkInterface(
            ...
            # An empty access configuration enables public public internet access to the server
