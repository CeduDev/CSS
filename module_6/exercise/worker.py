...
class TicketWorker:
    ...
    def initialize_rabbitmq(self):
        ...
        # Ticket event exchange and queue
    ...
    def handle_ticket_event(self, ch, method, properties, body):
        ...
        if (
            ticket_event.customer_id not in CUSTOMERS_DATABASE
            or ticket_event.ride_number not in RIDES_DATABASE.keys()
        ):
            ch.basic_nack(
            ...
            customer_event = CustomerEvent(
                ...
                cost=RIDES_DATABASE.get(ticket_event.ride_number),
    ...
    def start_consuming(self):
        ...
        self.channel.basic_consume(
            queue=self.queue, on_message_callback=handle_event, auto_ack=True
        )
